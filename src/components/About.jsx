            ...
            <div className="max-w-7xl mx-auto px-6 relative">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                    <div className="relative">
                        ...
                        >
                            <div className="aspect-[4/5] rounded-[3rem] overflow-hidden shadow-[0_48px_80px_-16px_rgba(0,0,0,0.15)] border-8 border-white">
                                <img
                            ...
                            <motion.div
                                ...
                                className="absolute -bottom-10 -left-10 glass p-8 rounded-3xl shadow-2xl max-w-xs border-white/50 bg-white/90 backdrop-blur-xl"
                            >
                                <div className="flex items-center gap-4 mb-4">
                                    <div className="h-12 w-12 rounded-2xl bg-primary flex items-center justify-center text-secondary shadow-lg">
                                        <Rocket size={24} />
                                    </div>
                                    <h4 className="text-2xl font-black text-gray-900 leading-none">2026 <br /><span className="text-[10px] uppercase tracking-widest text-gray-400">VISION GOAL</span></h4>
                                </div>
                                <p className="text-gray-600 font-medium">Empowering over 1M+ Nigerians through industrial inclusion.</p>
                            </motion.div>
                        </motion.div>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-6xl font-black text-gray-900 mb-10 leading-tight">
                                Modernizing the <span className="text-primary italic font-serif">Heartbeat</span> of Nigeria.
                            </h2>

                            <div className="space-y-8 mb-12">
                                <div className="flex gap-6">
                                    <div className="shrink-0 h-10 w-10 rounded-full bg-secondary/20 flex items-center justify-center text-primary font-bold">1</div>
                                    <div>
                                ...
                                <div className="flex gap-6">
                                    <div className="shrink-0 h-10 w-10 rounded-full bg-secondary/20 flex items-center justify-center text-primary font-bold">2</div>
                                    <div>
